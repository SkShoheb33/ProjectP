...
function ProjectInfo(props) {
  return (
    <div className='flex flex-col items-start p-6'>
        <FontAwesomeIcon onClick={props.goToMain} className='mr-2 text-2xl hover:cursor-pointer hover:bg-gray-100 p-2 rounded-full mb-3' icon={faArrowLeft} />
        ...
        <div className='flex flex-row w-full my-7 justify-between'>
            ...
            <div className='flex w-1/2 justify-around'>
              <div className='bg-blue-500 hover:cursor-pointer w-1/3 text-white py-1 rounded-md font-semibold'>Join </div>
              <div className='bg-gray-500 hover:cursor-pointer w-1/3 text-white py-1 rounded-md font-semibold'>Observe </div>
            </div>
        </div>
